                                            ...
                                            <div className="flex flex-col sm:flex-row">
                                                ...
                                                <div className="p-5 flex-1 flex flex-col">
                                                    ...
                                                    <div className="flex gap-3 mt-auto">
                                                        <button
                                                            className="flex-1 flex items-center justify-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold text-white bg-linear-to-r from-pink-500 to-rose-500 hover:brightness-110 hover:scale-105 transition-all duration-300 shadow-md shadow-pink-500/30"
                                                            onClick={() => reviewRequest("rejected", request._id)}
                                                        >
                                                            Reject
                                                        </button>
                                                        <button
                                                            className="flex-1 flex items-center justify-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold text-white bg-linear-to-r from-indigo-500 to-violet-500 hover:brightness-110 hover:scale-105 transition-all duration-300 shadow-md shadow-violet-500/30"
                                                            onClick={() => reviewRequest("accepted", request._id)}
                                                        >
                                                            Accept
                                                        </button>
